...
-   Transform a data frame affected by data multicollinearity into a new
    a data frame with a maximum degree of data correlation among variables
...
It is also possible to estimate the observation using the transformation matrix.
...
In this example I also estimated the bias.
