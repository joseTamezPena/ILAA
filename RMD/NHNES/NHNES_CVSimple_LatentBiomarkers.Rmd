...
cases <- subset(NHNESDep,depressionTot==1)
control <- subset(NHNESDep,depressionTot==0)
set.seed(1)
NHNESDepEq <- rbind(cases[sample(nrow(cases),min(tbdep)),],control[sample(nrow(control),min(tbdep)),])

table(NHNESDepEq$depressionTot)
