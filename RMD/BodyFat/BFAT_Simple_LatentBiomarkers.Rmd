...
pander::pander(obsCoef,caption="From Decorrelation Formula")
...
pander::pander(colnames(trainfat_driven2))
...
obsCoef <- getObservedCoef(trainDe,fatmodel_DE2$coef)
...
lmod <- lm(paste("BodyFat~1+",str_flatten(names(fatmodel$coef)[-1],collapse="+"),sep=""),trainingset)
pander::pander(summary(lmod))

lmod_DE <- lm(paste("BodyFat~ 1+",str_flatten(names(fatmodel_DE$coef)[-1],collapse="+"),sep=""),trainfat_driven)
pander::pander(summary(lmod_DE))

lmod_DE2 <- lm(paste("BodyFat~ 1+",str_flatten(names(fatmodel_DE2$coef)[-1],collapse="+"),sep=""),trainfat_driven2)
