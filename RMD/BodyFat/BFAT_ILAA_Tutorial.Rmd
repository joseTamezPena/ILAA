...
``` r
  ...
  attr(body_fat_Decorrelated,"R.critical")       #The estimated achieviable correlation
...
-   Each discovered latent variable is the residual of the observed
    ...
    Describes that the $Wrist$ is associated with the
    $Weight$ and $Neck$. The latent variable $LaWrist$ is the amount of
    information in the $Wrist$ not found by $Weight$ nor the $Neck$.
...
attr(body_fat_Decorrelated,"LatentVariables")
attr(body_fat_Decorrelated,"fscore")
