...
if (DeOutcome != "Driven")
{
  DEdataframeTrain <- IDeA(dataframe,thr=thr,method=method,type=type,corRank=corRank,relaxed=FALSE,verbose = TRUE)
} else
{
  DEdataframeTrain <- IDeA(dataframe,Outcome=outcome,thr=thr,method=method,type=type,relaxed=FALSE,corRank=corRank,verbose = TRUE)
}
