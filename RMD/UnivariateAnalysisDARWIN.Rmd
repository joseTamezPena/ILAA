...
#DEdataframe <- GDSTMDecorrelation(dataframe,thr=0.60,method="spearman",type="RLM",verbose = TRUE)
#DEdataframe <- GDSTMDecorrelation(dataframe,thr=0.60,verbose = TRUE)
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=0.60,verbose = TRUE)
