...
deThermal <- GDSTMDecorrelation(SalivaThermal_Avg,thr=0.90,verbose = TRUE,skipRelaxed=FALSE,corRank=FALSE)
...
gplots::heatmap.2(log(abs(GDSTM)+1),
                  trace = "none",
#                  scale = "none",
                  mar = c(5,5),
                  col=rev(heat.colors(5)),
