...
# Validating ILAA as metod to recover the tranSBormation matrix structure

We will simulate a set of sparse random tranSBormations, and we test if ILAA is able to recover the inverse tranSBormation
The data will consist of a set of N random variables half Gaussian, half with uniform distribution.
The tranSBormation matrix will only create a set of 10 correlated variables
...
boxplot(list(Pearson_1=DiscoverySenT,Pearson_2=DiscoverySenB,Spearman_1=DiscoverySenST,Spearman_2=DiscoverySenSB),
        main="Sensitivity",ylab="Sensitivity")
boxplot(list(Pearson_1=DiscoverySpeT,Pearson_2=DiscoverySpeB,Spearman_1=DiscoverySpeST,Spearman_2=DiscoverySpeSB),
