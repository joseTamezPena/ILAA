...
if (DeOutcome != "Driven")
{
  DEdataframeTrain <- GDSTMDecorrelation(dataframe,thr=thr,method=method,type=type,corRank=corRank,verbose = TRUE)
} else
{
  DEdataframeTrain <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=thr,method=method,type=type,corRank=corRank,verbose = TRUE)
}
